    ...
    <section ref={container} className="bg-fondo py-24 md:py-32 px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-20">
          ...
          <h3 className="text-4xl md:text-6xl font-sans font-bold text-principal leading-tight">
            El camino hacia la <span className="font-serif italic text-acento">Implementación</span>
          </h3>
          <p className="mt-6 text-slate-500 font-mono text-sm max-w-2xl mx-auto">
            Basado en los lineamientos del Derecho de Petición 2026ER0026461
          </p>
        </div>

        {/* PAVIS Screenshot Section */}
        <div className="step-card w-full mb-16 rounded-[3rem] overflow-hidden shadow-2xl relative border-4 border-white">
          <div className="absolute inset-0 bg-gradient-to-t from-principal/90 via-transparent to-transparent z-10 flex items-end p-8 md:p-12">
            <div>
              <span className="bg-acento text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-4 inline-block">Plataforma Oficial</span>
              <h4 className="text-3xl md:text-4xl font-bold text-white mb-2">Sistema PAVIS</h4>
              <p className="text-white/80 max-w-2xl">La puerta de entrada al programa. Aquí se registran las iniciativas, se validan las OPV y se da seguimiento en tiempo real a cada proyecto de autogestión.</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
          ...
          {/* Card 1 */}
          <div className="step-card bg-principal text-white p-10 rounded-[3rem] relative shadow-2xl z-10">
            <Calendar size={40} className="text-acento mb-6" />
            <h4 className="text-2xl font-bold mb-4">Cronograma 2026</h4>
          ...
          {/* Card 2 */}
          <div className="step-card glass p-10 rounded-[3rem] relative overflow-hidden group">
            ...
            <div className="text-principal opacity-10 absolute -top-4 -right-4 font-mono text-9xl font-bold pointer-events-none">03</div>
            
            <MonitorPlay size={40} className="text-principal mb-6" />
            <h4 className="text-2xl font-bold text-principal mb-4">Acompañamiento Incial</h4>
