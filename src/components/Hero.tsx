...
const Hero = () => {
  ...
  return (
    <section ref={container} className="relative w-full h-[100dvh] flex flex-col justify-center px-6 md:px-16 overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-6xl mx-auto w-full text-white mt-16 md:mt-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7">
            ...
            <h1 className="hero-elem text-4xl md:text-6xl lg:text-7xl font-sans font-bold leading-tight mb-2">
              Autogestión de Vivienda
            </h1>
            <h2 className="hero-elem text-3xl md:text-5xl lg:text-6xl font-serif italic text-white/80 mb-6">
              Nueva Urbana.
            </h2>
          ...
          <div className="hero-elem lg:col-span-5 flex flex-col items-center justify-center gap-8 mt-12 lg:mt-24 relative">
             ...
             <img 
               ...
               className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 object-contain drop-shadow-[0_0_40px_rgba(255,255,255,0.4)] transform hover:scale-105 transition-transform duration-500 relative z-10" 
             ...
             <button 
              ...
              className="group relative overflow-hidden rounded-full bg-white text-principal px-10 py-5 font-bold hover:scale-105 transition-transform duration-300 w-full max-w-[300px] text-center flex justify-center shadow-2xl z-10 text-lg"
            >
